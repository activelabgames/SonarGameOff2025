...
[CustomEditor(typeof(AllParametersContainerSO))]
public class AllParametersContainerSOEditor : Editor
{
    ...
    {
        AllParametersContainerSO container = (AllParametersContainerSO)target;
        ...
        EditorGUILayout.LabelField("📦 Vue Centralisée des Paramètres", EditorStyles.whiteLargeLabel);
        EditorGUILayout.Space(10);
        
        // 2. Itérer et Dessiner les Éditeurs Personnalisés
        foreach (ScriptableObject parametersSO in container.GameSystemsParameters)
        {
