// WeaponsParametersContainerSOEditor.cs (Doit être dans un dossier 'Editor')
using UnityEditor;
using UnityEngine;
using System.Collections.Generic;
using Sonar;

[CustomEditor(typeof(WeaponsParametersContainerSO))]
public class WeaponsParametersContainerSOEditor : Editor
{
    ...
    {
        WeaponsParametersContainerSO container = (WeaponsParametersContainerSO)target;
        ...
        EditorGUILayout.LabelField("📦 Paramètres des armes", EditorStyles.whiteLargeLabel);
        EditorGUILayout.Space(10);
        
        // 2. Itérer et Dessiner les Éditeurs Personnalisés
        foreach (ScriptableObject parametersSO in container.WeaponsParameters)
        {
